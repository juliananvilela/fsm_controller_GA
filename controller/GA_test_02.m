...
for j=1:num_paths
    ...
    while a==0
      ...
      index = curStateIndex(trans_mat,pos_cur_states);
      if(index == -1)
      ...
      J = index; % get state number of transition
        ...
        if aux==0
            ...
            event_bot = next_event(1)-96;
                ...
                calcTransitionCost(next_event,i,pos_cur_states,state_path{j},possible_transitions,tasks,0,regions,numRegions,start_loc,...
