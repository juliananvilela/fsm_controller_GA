function [plan,plan_state,plan_cost,num_spoint] = GA_abstract_New_5(population_size,max_rep,mutation_rate,stop_cond,states,start_loc,numTasks,numRobots,numRegions,tasks,regions,robot_tasks)
abstracted = true;
