function [costs,paths] = ...
  localDijkstra(init_cost,E,cur_state,ABS_event_path,ABS_pc,numRobots,states,tasks,EEC,regions,numRegions,start_loc,numTasks,abstracted,start_events_only)
...
%         transition_cost = cost(I,J);
      ...
      if numel(path{J}) > 1 % prevent calculating a path for the start state
        ...
        cur_event_path = stripEventPath(cur_event_path);
