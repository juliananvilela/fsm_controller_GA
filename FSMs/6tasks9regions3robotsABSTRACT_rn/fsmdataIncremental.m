% events = {'name', bot, 'type', 'type_name'} Scenario 51.2 - Comparable with scenario 51, however with the new approach of changing problem model based on the global plan
